...
<center>
	商品名称：<input class="easyui-textbox"  style="width:200px" name="goodsName" value="${goods.goodsName }"> <br>
	商品价格：<input type="text" class="easyui-numberbox" data-options="min:0,precision:2"  name="goodsPrice"value="${goods.goodsPrice }"> <br>
	商品类型：
				<select id="cc" class="easyui-combobox" name="goodsTypeId" style="width:200px;">   
			    <option value="-1">--请选择--</option>   
			    <c:forEach items="${typeList }" var="type">
			    	<option value="${type.goodsTypeId}"    ${type.goodsTypeId==goods.goodsId ?"selected":"" } >${type.goodsTypeName }</option>  
			    </c:forEach>
				</select>   <br>

	商品库存：<input class="easyui-textbox"  style="width:200px" name="goodsCount" value="${goods.goodsCount }"> <br>
	生产时间：<input  id="dd"  type= "text" class= "easyui-datebox"  name="goodsDate"value="${goods.goodsDate }"> <br> 
